...
class LiveCaptionPlayerViewController: UIViewController {
    ...
    // MARK: - 定数
    let remoteFileUrl: [String] = ["http://nakano-global-2.jst-lab.com:8080/caption/servlet/master/master_1495948248.m3u8",
                                   "http://nakano-global-2.jst-lab.com:8080/caption/servlet/master/master_1495948248.m3u8",
                                   "http://nakano-global-2.jst-lab.com:8080/caption/servlet/master/master_1495948248.m3u8"]
    ...
    func setSubtitles(){
        ...
        if(subtitleList.count > 0){
            ...
            self.SubtitleStackView.heightAnchor.constraint(equalToConstant: stackViewHeight).isActive = true
            ...
            self.SubtitleStackView.addArrangedSubview(offButton)
