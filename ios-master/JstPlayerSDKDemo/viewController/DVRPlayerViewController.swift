...
class DVRPlayerViewController: UIViewController {
    ...
    var remoteFileUrl: [String] = ["https://eqlive-eqd015yfct-live.eq.hls.wselive.stream.ne.jp/eq-live/1/eqlive-eqd015yfct-live/fmsins-00002/stream-00002-high/chunklist.m3u8",
                                   "http://nakano-global-2.jst-lab.com/caption/servlet/master/7432459/master.m3u8",
    ...
    func initPlayerView(){
        ...
        self.videoView.initPlayer(url: remoteFile, startPosition: 0, autoPlay: true, mediaMode: JstPlayerSDK.mediaMode.dvr.rawValue, title: "hoge")
