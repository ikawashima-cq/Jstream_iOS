...
class PlayerDemoViewController: UIViewController {
    ...
    let remoteFileUrl: [String] = ["https://eqd114dmqf.eq.webcdn.stream.ne.jp/www50/eqd114dmqf/jmc_pub/jmc_pd/00005/3de025097f204317ae9c2b27d82582b6.m3u8",
                                   ...
                                   "https://eqlive-eqd015yfct-live.eq.hls.wselive.stream.ne.jp/eq-live/1/eqlive-eqd015yfct-live/fmsins-00002/stream-00002-high/chunklist.m3u8"]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "toPlayerDemowithLive":
            index = 2
            MenuBar.title = "PlayerDemo - Live"
        case "toPlayerDemowithDVR":
            index = 1
            MenuBar.title = "PlayerDemo - DVR"
        case "toPlayerDemowithVOD":
            index = 0
            MenuBar.title = "PlayerDemo - VOD"
        default:
            index=0
        }
    }
