...
- (instancetype)init {
    self = [super init];
    if (self) {
        _beacon_vr_live_video = @"https://e9efbdc0b7387d08b8183210c656d7a4.cdnext.stream.ne.jp/beacon/play.html?beacontype=vr_live_video";
        _beacon_vr_live_video_test = @"https://e9efbdc0b7387d08b8183210c656d7a4.cdnext.stream.ne.jp/beacon/play.html?beacontype=vr_live_video_test";
//        _beacon_vr_live_video_test = @"https://log11stg.interactive-circle.jp/data11/$@.gif";
        _beacon_vr_live_ad = @"https://e9efbdc0b7387d08b8183210c656d7a4.cdnext.stream.ne.jp/beacon/play.html?beacontype=vr_live_ad";
        _beacon_vr_live_ad_test = @"https://e9efbdc0b7387d08b8183210c656d7a4.cdnext.stream.ne.jp/beacon/play.html?beacontype=vr_live_ad_test";
...
//        _beacon_jst_ad_test
        _beacon_jst_trace = @"https://e9efbdc0b7387d08b8183210c656d7a4.cdnext.stream.ne.jp/beacon/play.html?beacontype=jst_trace";
