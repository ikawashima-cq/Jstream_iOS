...
- (NSString *)stringAsJson {
    ...
    return [NSString stringWithFormat:@"{\"adsParams\":{\"device\":\"%@\",\"program\":\"%@\",\"fod_postal\":\"%@\",\"fod_short_postal\":\"%@\",\"gender\":\"%@\",\"age\": \"%d\",\"site_domain\":\"%@\",\"ifa\":\"%@\",\"bundle\":\"%@\",\"domain\":\"%@\",\"name\":\"%@\"}}", device, mediaId, postCode, postCodeShort, gender, age, domain, ifa, bundleID, domain, appName];
}
